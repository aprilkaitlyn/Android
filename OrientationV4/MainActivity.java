package com.example.orientationv4;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupGUI(); //make layout programmatically
    ...
    private void setupGUI() {
        ...
        linearLayout.setOrientation(LinearLayout.VERTICAL); //vertical is constant that = 1
        linearLayout.setGravity(LinearLayout.VERTICAL); //should center it
        ...
        ViewGroup.LayoutParams params = new ViewGroup.LayoutParams  //had to import LayoutParams to ViewGroup
        ...
        linearLayout.addView(b1); //"inject the buttons into the layout"
