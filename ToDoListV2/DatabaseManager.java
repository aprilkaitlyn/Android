...
public class DatabaseManager extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "todoDB2";
    ...
    public ArrayList<ToDo> selectAll() { //from DeleteActivity
        ...
        while(cursor.moveToNext()) {
            ToDo currentToDo = new ToDo(Integer.parseInt(cursor.getString(0)), cursor.getString(1), cursor.getString(2));
